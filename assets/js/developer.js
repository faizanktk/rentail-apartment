...
var success3 = $('.alert-success', form3);
   ...
   //--------- Get cities by ajax -----------------//
	...
	//------------ Get cities foe search -------
	function search_getcities(state_id){
		$.ajax({
			type: "POST",
			   url: baseurl+"home/search_getcities",
			   data: {state_id:state_id}, 
			   success: function(data)
			   {
				   $('#search_cities_id').html(data);//alert(data); // show response from the php script.
			   }
		});
		}
	//-------- Profile validation ------------------
    ...
    comments.validate({
                ...
                submitHandler: function (form) {
                   ...
                   $.ajax({
					   ...
					   beforeSend: function() { $('#comment-circle').css('display','block'); },
					   complete: function() { $('#comment-circle').css('display','none');  },
    ...
    propertyemailcontact.validate({
                ...
                submitHandler: function (form) {
                   ...
                   $.ajax({
					   ...
					   beforeSend: function() { $('#login-circle').css('display','block'); },
					   complete: function() { $('#login-circle').css('display','none');  },
    ...
    propertycontact.validate({
                ...
                submitHandler: function (form) {
                   ...
                   $.ajax({
					   ...
					   beforeSend: function() { $('#islogin-circle').css('display','block'); },
					   complete: function() { $('#islogin-circle').css('display','none');  },
