			...
			<div class="col-md-12 col-lg-8 col-lg-offset-2">
				<div class="row">
					...
					<div class="col-sm-6">
                        ...
                        Dear Member ASDF Your payment was successful, thank you for membership
                        
                        <p style="color: #646464;">Membership : 
                        <strong style="font:15px Arial,Helvetica,sans-serif;color:#f09"><?php echo $item_name; ?></strong>
                        </p><br/>
